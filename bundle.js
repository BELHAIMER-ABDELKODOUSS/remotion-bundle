...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "tiktok_generator:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktiktok_generator"] = self["webpackChunktiktok_generator"] || [];
...
const RemotionVideo = ({
  ...
  const getDurationFrame = () => {
    ...
    const duration = ((_a = captions[captions.length - 1]) == null ? void 0 : _a.end) / 1e3 * fps;
  ...
  const getCurrentCaptions = () => {
    ...
    const currentTime = frame / 30 * 1e3;
    const currentCaption = captions.find(
      (word) => currentTime >= word.start && currentTime <= word.end
    );
    return currentCaption ? currentCaption == null ? void 0 : currentCaption.text : "";
  };
  const defaultImageList = imageList && imageList.length > 0 ? imageList : [
    "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400",
    "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400",
    "https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=400"
  ];
  const defaultCaptions = captions && captions.length > 0 ? captions : [
    { start: 0, end: 2e3, text: "Welcome to our video" },
    { start: 2e3, end: 4e3, text: "This is a sample caption" },
    { start: 4e3, end: 6e3, text: "Thank you for watching" }
  ];
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { backgroundColor: "black" } }, defaultImageList == null ? void 0 : defaultImageList.map((item, index) => {
    const startTime = index * getDurationFrame() / (defaultImageList == null ? void 0 : defaultImageList.length);
    const duration = getDurationFrame();
    const scale = (index2) => (0,esm.interpolate)(
      frame,
      [startTime, startTime + duration / 2, startTime + duration],
      index2 % 2 == 0 ? [1, 1.8, 1] : [1.8, 1, 1.8],
      { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
    );
    return /* @__PURE__ */ react.createElement("div", { key: index }, /* @__PURE__ */ react.createElement(
      esm.Sequence,
      {
        key: index,
        from: startTime,
      ...
      /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement("h2", { style: { fontSize: "2rem" } }, getCurrentCaptions())
        )
      )
    ));
  }), audioFileUrl && audioFileUrl.trim() !== "" && /* @__PURE__ */ react.createElement(esm.Audio, { src: audioFileUrl })));
};
/* harmony default export */ const remotion_RemotionVideo = (RemotionVideo);
...
const RemotionRoot = () => {
  const sampleCaptions = [
    { start: 0, end: 2e3, text: "Welcome to our video" },
    { start: 2e3, end: 4e3, text: "This is a sample caption" },
    { start: 4e3, end: 6e3, text: "Generated with Remotion" }
  ];
  const sampleImages = [
  ...
  const calculateDuration = (captions) => {
    if (!captions || captions.length === 0) {
      console.log(
        "No captions found, using default duration of 900 frames (30s)"
      );
      return 900;
    }
    console.log("Calculating duration from captions:", captions);
    const lastCaption = captions[captions.length - 1];
    console.log("Last caption:", lastCaption);
    if (!lastCaption || typeof lastCaption.end !== "number") {
      console.log("Invalid caption data, using default duration");
      return 900;
    }
    const durationInSeconds = lastCaption.end / 1e3;
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    {
      id: "RemotionVideo",
      component: remotion_RemotionVideo,
      ...
      calculateMetadata: ({ props }) => {
        console.log("calculateMetadata called with props:", props);
        const captions = (props == null ? void 0 : props.captions) || sampleCaptions;
        const duration = calculateDuration(captions);
        console.log("Final calculated duration:", duration);
        return {
          durationInFrames: duration,
          props: {
            // Use passed props or fall back to sample data
            audioFileUrl: (props == null ? void 0 : props.audioFileUrl) || "https://res.cloudinary.com/dhuallbz6/video/upload/v1739660779/audio/b94be64d-cbf9-4263-8250-753aeaa3f2bc.mp3",
            captions,
            imageList: (props == null ? void 0 : props.imageList) || sampleImages,
            script: props == null ? void 0 : props.script
          }
        };
      }
    }
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 247).then(__webpack_require__.bind(__webpack_require__, 9247)).then(({ StudioInternals }) => {
